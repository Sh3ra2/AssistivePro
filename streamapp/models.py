...
class profile_image(models.Model):
    ...
    name = models.CharField(max_length=122, default="None", blank= True, null=True, validators=[RegexValidator(r'^[a-zA-Z]*$', 'Only alphabets are allowed.')])
...
class settings_model(models.Model):
    ...
    head_turn_count =  models.IntegerField(blank= True, null=True, default=7, validators=[MinValueValidator(1)])
    head_count_time_sec = models.IntegerField(blank= True, null=True, default=60, validators=[MinValueValidator(1)])
    left_head_threshHold = models.IntegerField(blank= True, null=True, default=-6, validators=[MaxValueValidator(-1)])
    right_head_threshHold = models.IntegerField(blank= True, null=True, default=6, validators=[MinValueValidator(1)])